<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FlightPayment.aspx.cs" Inherits="Index" %>
						...
						<div class="flight-list-v2">
							<div class="flight-list-main">	
								<div class="col-md-2 col-sm-2 text-center airline">
									...
									<h6>
                                        <asp:Label ID="lblfname" runat="server" Text=""></asp:Label></h6>
								</div>
								<div class="col-md-3 col-sm-3 departure">
									<h3><i class="fa fa-plane"></i> 
                                        <asp:Label ID="lblftime" runat="server" Text=""></asp:Label></h3>
									<h5 class="bold">
                                        <asp:Label ID="lblfdate" runat="server" Text=""></asp:Label></h5>
									<h5><asp:Label ID="lblfloc" runat="server" Text=""></asp:Label></h5>
								</div>
								...
								<div class="col-md-3 col-sm-3 destination">
									<h3><i class="fa fa-plane fa-rotate-90"></i> 
                                        <asp:Label ID="lblttime" runat="server" Text=""></asp:Label></h3>
									<h5 class="bold">
                                        <asp:Label ID="lbltdate" runat="server" Text=""></asp:Label></h5>
									<h5>
                                        <asp:Label ID="lbltloc" runat="server" Text=""></asp:Label></h5>
								</div>
							</div>
							<div class="clearfix"></div>
							<div class="flight-list-footer">
								<div class="col-md-6 col-sm-6 col-xs-6 sm-invisible">
									<span><i class="fa fa-plane"></i> </span>
									<span class="refund"><i class="fa fa-undo"></i> </span>
									<span><i class="fa fa-suitcase"></i></span>
								</div>
							</div>
						</div>
						<div class="login-box">
							<h3>Continue booking as a guest</h3>
							<div class="booking-form">
								<div class="col-md-6 col-sm-6">
										<label>Name</label>
                                    <asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" required placeholder="Enter Your Name"></asp:TextBox>
										<label>Email</label>
                                         <asp:TextBox ID="TextBox2" CssClass="form-control" runat="server" required placeholder="Enter Your Email"></asp:TextBox>
										<label>Mobile Number (Optional)</label>
					                    <asp:TextBox ID="TextBox3" CssClass="form-control" runat="server" placeholder="Enter Mobile Number"></asp:TextBox>
                                    <asp:Button ID="btn_submit" class="search-button btn transition-effect" 
                                            runat="server" Text="Confirm Booking" onclick="btn_submit_Click" />
							...
							<div class="sidebar-body">
								<table class="table">
									...
									<tr>
										<td>Service Fee</td>
										<td>
                                            <asp:Label ID="lblsfee" runat="server" Text="450"></asp:Label></td>
									</tr>
									<tr>
										<td>Airport Taxes</td>
										<td>
                                            <asp:Label ID="lblafee" runat="server" Text="655"></asp:Label></td>
									</tr>
									<tr>
										<td>You Pay</td>
										<td class="total">
