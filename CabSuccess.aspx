<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CabSuccess.aspx.cs" Inherits="Index" %>
					...
					<div class="col-md-8 col-sm-8">
						<div class="booking-summary-v2">
							...
							<div class="col-md-6 col-sm-6">
								<h4>
                                    <asp:Label ID="lblcname" runat="server" Text=""></asp:Label> <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></h4>
								<div class="col-md-6 col-sm-6 col-xs-6 clear-padding">
									<p>Location From</p>
									<p><i class="fa fa-calendar"></i> 
                                        <asp:Label ID="lblfloc" runat="server" Text=""></asp:Label></p>
								</div>
								<div class="col-md-6 col-sm-6 col-xs-6 clear-padding">
									<p>Location To</p>
									<p><i class="fa fa-calendar"></i><asp:Label ID="lbltloc" runat="server" Text=""></asp:Label></p>
								</div>
								<div class="clearfix"></div>
								<p><span>Passengers(s)</span> - 
                                    <asp:Label ID="lblno" runat="server" Text=""></asp:Label> Passenger</p>
								<p><span>Car Type</span> - Sedan</p>
							</div>
